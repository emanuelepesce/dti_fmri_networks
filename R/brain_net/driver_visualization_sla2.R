...
for(d in dirs_1){
  ...
  pathIn.membership <- paste(pathIn.dir, "membership_sla2.csv", sep = "")
  pathOut.node <- paste(pathOut.dir, "sla2_node.node", sep = "")
  
  pathOut.edge <- paste(pathOut.dir, "sla2_fmri.edge", sep = "")
  gen_all_files_brainnet(pathIn.graph, pathIn.membership, pathOut.node, 
                         pathOut.edge, e.attr = "fmri")
  pathOut.edge <- paste(pathOut.dir, "sla2_dti.edge", sep = "")
  gen_all_files_brainnet(pathIn.graph, pathIn.membership, pathOut.node, 
