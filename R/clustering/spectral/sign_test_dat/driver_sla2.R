...
for(nc in kmin:kmax){
  print("#######################################################")
  print(nc)
  pathIn_graphs <- "./../../../../data/graphs_integration/sign_test/SLA2/"
  pathIn_exampleGraph <- "./../../../../data/results/signtest_example_graph.graphml"
  
  pathOut_base <- paste("./../../../../data/results/spec_clust/", nc, "/sign_test/", sep ="")
  ...
  pathOut_graph2D <- paste(pathOut_base, "graph2d_sla2.jpeg", sep ="")
