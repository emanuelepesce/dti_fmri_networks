...
pathOut_heat <- paste(pathOut_base, nc, "/heatmap_controls.jpeg", sep ="")
...
for (nc in 6:11){  
  pathOut_mem <- paste(pathOut_base, nc, "/membership_controls.csv", sep ="")
  pathOut_graph3D <- paste(pathOut_base, nc, "/graph3d_controls.jpeg", sep ="")
  pathOut_graph2D <- paste(pathOut_base, nc, "/graph2d_controls.jpeg", sep ="")
