#' spectral clustering on borda sla3
#' 
...
print("#######################################################")
print(nc)
pathIn_graphs <- "./../../../../data/graphs_integration/borda_sw_004/SLA3/"
...
pathOut_heat <- paste(pathOut_base, nc, "/heatmap_sla3.jpeg", sep ="")
...
for (nc in 6:11){  
  pathOut_mem <- paste(pathOut_base, nc, "/membership_sla3.csv", sep ="")
  pathOut_graph3D <- paste(pathOut_base, nc, "/graph3d_sla3.jpeg", sep ="")
  pathOut_graph2D <- paste(pathOut_base, nc, "/graph2d_sla3.jpeg", sep ="")
