...
rand_walk_weighted <- function(graph, weights, seed, toTel = 45){
...
rand_walk_weighted_dir <- function(pathIn, pathOut, form, times, toTel, seed,
                                   verbose = 1){
  ...
  for(i in 1:length(files)) {
    ...
    for (t in 1:times){
      print(t)
      r_tmp <- rand_walk_weighted(g, w, seed, toTel)
